...
//
// class AddFranchiseProfileScreen extends StatefulWidget {
//   const AddFranchiseProfileScreen({Key? key}) : super(key: key);
//
//   @override
//   _AddFranchiseProfileScreenState createState() => _AddFranchiseProfileScreenState();
// }
//
// class _AddFranchiseProfileScreenState extends State<AddFranchiseProfileScreen> {
...
//               const SnackBar(
//                 content: Text('Franchise profile created successfully!'),
//                 backgroundColor: Colors.green,
//               ),
//             );
//
//             Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>DigiLockerVerificationScreen(profileImage: _imageFile, type: 'franchise',)));
//
//           } else if (response == false) {
//             // API returned false
//             ScaffoldMessenger.of(context).showSnackBar(
//               const SnackBar(
//                 content: Text('Failed to create franchise profile. Please try again.'),
...
//
//   bool _formHasData() {
//     return _brandNameController.text.isNotEmpty ||
