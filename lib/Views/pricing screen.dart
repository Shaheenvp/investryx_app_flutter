...
//     // You might want to get these values from user data or app state
...
//           amount: int.parse(plan['rate'].toString()),
...
//
//     try {
//       // Pass the initial plan type when fetching plans
//       String initialType = _planTypeMap[_selectedPlan] ?? 'advisor';
//       print('Fetching plans with initial type: $initialType'); // Debug log
//
//       var plans = await PlansGet.fetchPlans(initialType);
//       print('Received plans: $plans'); // Debug log
//
//       if (plans != null) {
//         setState(() {
//           _allPlans = List<Map<String, dynamic>>.from(plans);
//           _filterPlans();
//           _isLoading = false;
//         });
//       } else {
...
//           SnackBar(content: Text('Failed to load plans. Please try again later.')),
//         );
//       }
//     } catch (e) {
...
//                 ?.toList() ??
//                 [],
//             onSubscribe: () => _handleSubscription(plan),  // Updated this line
//           );
//         },
//       ),
//     );
...
//         ),
//         SizedBox(height: 16.h),
//         ...displayFeatures.map((feature) => Padding(
//           padding: EdgeInsets.only(bottom: 12.h),
//           child: Row(
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
...
//                 decoration: BoxDecoration(
//                   color: widget.recommended ? Color(0xFFFFCC00) : Color(0xFFF1F5F9),
//                   borderRadius: BorderRadius.circular(6.r),
//                 ),
//                 child: Icon(
//                   Icons.check,
//                   size: 12.sp,
//                   color: widget.recommended ? Colors.white : Color(0xFF1E293B),
//                 ),
//               ),
//               SizedBox(width: 12.w),
//               Expanded(
