...
class _ProfileHeaderWithSliderState extends State<ProfileHeaderWithSlider> {
  ...
  String _getDisplayPrice() {
    if (widget.type.toLowerCase() == "advisor") {
      ...
      return (widget.profile as BusinessInvestorExplr).rangeStarting ?? 'Investment size N/A';
    } else {
...
class _ProfileSwitcherState extends State<ProfileSwitcher> {
  ...
  Future<void> _fetchProfiles() async {
    if (!mounted) return;  // Add this check at the beginning
    ...
    try {
      ...
      if (!mounted) return;  // Add this check before using Get.snackbar
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    else if (widget.type.toLowerCase() == "advisor") {
                      await Get.to(() => AddAdvisorProfileScreen());
                    }
                    else {
